...
def parse_args():
    ...
    # Network
    parser.add_argument('--network',  type=str,default='/home/yusheng/code/new_grasp/trained-models/cornell-randsplit-rgbd-grconvnet3-drop1-ch32/epoch_19_iou_0.98',
    ...
    with torch.no_grad():
        for idx, (x, y, didx, rot, zoom) in enumerate(test_data):
            ...
            if args.vis:
                ...
                fig.savefig('grcnn_cornell/{}.pdf'.format(idx))
                fig.savefig('grcnn_cornell/{}.png'.format(idx))
