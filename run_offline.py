...
def parse_args():
    ...
    parser.add_argument('--rgb_path', type=str, default='/home/yusheng/cornell/01/pcd0100r.png',
                        help='RGB Image path')
    parser.add_argument('--depth_path', type=str, default='/home/yusheng/cornell/01/pcd0100_depth.tiff',
